...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Set'
        db.create_table('photologue_set', (
        ...
        db.send_create_signal('photologue', ['Set'])

        # Adding M2M table for field galleries on 'Set'
        db.create_table('photologue_set_galleries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('set', models.ForeignKey(orm['photologue.set'], null=False)),
            ('gallery', models.ForeignKey(orm['photologue.gallery'], null=False))
        ))
        db.create_unique('photologue_set_galleries', ['set_id', 'gallery_id'])


    def backwards(self, orm):
        
        # Deleting model 'Set'
        db.delete_table('photologue_set')

        # Removing M2M table for field galleries on 'Set'
        db.delete_table('photologue_set_galleries')
